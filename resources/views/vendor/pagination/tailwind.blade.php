                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium bg-gray-800 bg-white border border-gray-300 cursor-default leading-5 focus:ring-2">{{ $element }}</span>
                            </span>
                        @endif
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-black bg-blue-300 border border-gray-300 cursor-default leading-5 focus:ring-2 ring-blue-400">{{ $page }}</span>
                                    </span>
                                @else
