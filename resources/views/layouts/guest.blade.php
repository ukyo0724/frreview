...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width=20px height=20px fill="#000000" stroke="blue" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" class="w-20 h-20 text-white p-2 bg-green-500 rounded-full" viewBox="0 0 640 512">
